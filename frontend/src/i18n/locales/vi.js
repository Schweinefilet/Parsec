...
export const vi = {
    ...
    scene: {
        ...
        allToScale: '*mọi thứ theo tỉ lệ — các thiên thể vẫn ở đó, nhỏ hơn một điểm ảnh rất nhiều',
        drifting: 'Đang trôi',
        ...
        trueDistancesSizes: 'Khoảng cách + kích thước thực',
        compressedDistances: 'Khoảng cách nén',
        scaleAria: 'Bố cục: {state}. Nhấn để chuyển lần lượt giữa khoảng cách nén, khoảng cách thực, và khoảng cách kèm kích thước thực.',
        ...
        trails: 'Vệt quỹ đạo',
        trailsOnAria: 'Ẩn vệt quỹ đạo',
        trailsOffAria: 'Hiện vệt quỹ đạo',
