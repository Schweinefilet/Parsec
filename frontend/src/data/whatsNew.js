...
export const WHATS_NEW = [
    {
        version: '5.9',
        changes: [
            'Flying into the Satellite Tracker from the ISS card can no longer leave the globe stranded outside its card, with an empty band above it, until the page is reloaded.',
